...
class Death(Scene):
    ...
    quips = [
            ...
            "You're worse then your dad's jokes."
            ]
    ...
    def enter(self):
        ...
        if action == "shoot!":
            ...
            print(dedent("""
                ...
                die as the Gothon stops on your head and eats you.
                """))
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        while guess != cheatcode and guess != code and guesses < 9:
            
            print("BZZZZEDDD!")
            guesses += 1
            guess = input("[keypad]> ")

        if guess == code or guess == cheatcode:
            print(dedent("""
            ...
            print(dedent("""
                ...
                sickening melting sound as the machinism is fused
...
class TheBridge(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            under your arm and surpirse 5 Gothons who are trying to
            take control of the ship. Each ofd them has an even uglier
...
class EscapePod(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            the escape pod before thw whole ship explodes. it seems
...
class Engine(object):
    ...
    def play(self):
        ...
        # In case current_scene is == last_scene just enter the last scene and finish the game.
        current_scene.enter()
